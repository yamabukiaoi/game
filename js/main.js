...
SetUpMain.prototype.setStatus = function ({name, _maxhp, _hp, _mp, _def, _str,	_int,	_luk,	_mdf,	_agi,	_vit,	_dex, _maxexp, _exp, _walkSpeed, _runSpeed, _attackSpeed}){
	this.data.character = {
		name: name === '' ? '勇士' : name,
